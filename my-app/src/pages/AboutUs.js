...
const AboutUs = () => {
  return (
    <>
     <div className="text-center">
      ...
      className="flex justify-start">
        <div className="text-white bg-[#e1855a] px-12 py-1 rounded-r-2xl inline-block my-20 mb-7 scale-150 text-2xl font-bold shadow">
          ABOUT US
        </div>
      </motion.div>
      ...
      <div className="pt-2">
        <div className="text-white bg-[#336274] px-7 py-2 rounded-3xl inline-block text-2xl font-bold scale-150">
          Our Team
        </div>
      </div>
      ...
      {/* Executive Member 1 */}
       <div className="flex items-center space-x-4 w-[45%] scale-120 group">
        ...
        <img src="/myPhoto.jpg" alt="Executive 1" className="w-full h-full object-cover rounded-full" />
        </div>
        <div>
          <p className="text-4xl font-semibold relative cursor-pointer group-hover:text-[#336274]">
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vitae justo non velit facilisis pharetra. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vitae justo non velit facilisis pharetra. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vitae justo non velit facilisis pharetra.
            </span>
          </p>
    ...
    <div className="text-center mr-8 max-w-[400px]">
      ...
      <p className="text-gray-500 text-2xl ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam. Sed nisi. Nulla quis sem at nibh elementum imperdiet. Duis sagittis ipsum. Praesent mauris. Fusce nec tellus sed augue semper porta. Mauris massa. Vestibulum lacinia arcu eget nulla. </p>
    </div>

    {/* Arrow Symbol */}
    <div className="text-4xl mx-4 ">→</div> {/* You can replace this with an SVG if needed */}
